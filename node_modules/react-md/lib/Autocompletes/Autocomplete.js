(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'react-transition-group/CSSTransitionGroup', 'classnames', '../utils/getField', '../utils/omit', '../utils/findIgnoreCase', '../utils/fuzzyFilter', '../utils/caseInsensitiveFilter', '../utils/Positioning/getTextWidth', '../utils/PropTypes/oneRequiredForA11y', '../utils/PropTypes/controlled', '../utils/PropTypes/invalidIf', '../constants/keyCodes', '../Helpers/anchorShape', '../Helpers/fixedToShape', '../Helpers/positionShape', '../Lists/ListItem', '../Menus/Menu', '../TextFields/TextField'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-dom'), require('react-transition-group/CSSTransitionGroup'), require('classnames'), require('../utils/getField'), require('../utils/omit'), require('../utils/findIgnoreCase'), require('../utils/fuzzyFilter'), require('../utils/caseInsensitiveFilter'), require('../utils/Positioning/getTextWidth'), require('../utils/PropTypes/oneRequiredForA11y'), require('../utils/PropTypes/controlled'), require('../utils/PropTypes/invalidIf'), require('../constants/keyCodes'), require('../Helpers/anchorShape'), require('../Helpers/fixedToShape'), require('../Helpers/positionShape'), require('../Lists/ListItem'), require('../Menus/Menu'), require('../TextFields/TextField'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactDom, global.CSSTransitionGroup, global.classnames, global.getField, global.omit, global.findIgnoreCase, global.fuzzyFilter, global.caseInsensitiveFilter, global.getTextWidth, global.oneRequiredForA11y, global.controlled, global.invalidIf, global.keyCodes, global.anchorShape, global.fixedToShape, global.positionShape, global.ListItem, global.Menu, global.TextField);
    global.Autocomplete = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactDom, _CSSTransitionGroup, _classnames, _getField, _omit, _findIgnoreCase, _fuzzyFilter, _caseInsensitiveFilter, _getTextWidth, _oneRequiredForA11y, _controlled, _invalidIf, _keyCodes, _anchorShape, _fixedToShape, _positionShape, _ListItem, _Menu, _TextField) {
  'use strict';
