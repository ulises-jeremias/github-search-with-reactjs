(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'classnames', 'react-prop-types/lib/deprecated', '../utils/PropTypes/requiredForA11yIfNot', '../utils/PropTypes/invalidIf', '../FontIcons/FontIcon', '../FontIcons/getDeprecatedIcon', './contextTypes'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../utils/PropTypes/requiredForA11yIfNot'), require('../utils/PropTypes/invalidIf'), require('../FontIcons/FontIcon'), require('../FontIcons/getDeprecatedIcon'), require('./contextTypes'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.classnames, global.deprecated, global.requiredForA11yIfNot, global.invalidIf, global.FontIcon, global.getDeprecatedIcon, global.contextTypes);
    global.DataTable = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _classnames, _deprecated, _requiredForA11yIfNot, _invalidIf, _FontIcon, _getDeprecatedIcon, _contextTypes) {
  'use strict';
