(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'classnames', 'react-prop-types/lib/deprecated', '../constants/keyCodes', '../utils/getField', '../utils/themeColors', '../utils/Positioning/viewport', '../utils/PropTypes/controlled', '../Helpers/anchorShape', '../Helpers/fixedToShape', '../Helpers/positionShape', '../Helpers/Layover', '../FontIcons/FontIcon', '../FontIcons/getDeprecatedIcon', '../TextFields/TextField', './TableColumn', './EditDialog', './findTable', './findFixedTo'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-dom'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../constants/keyCodes'), require('../utils/getField'), require('../utils/themeColors'), require('../utils/Positioning/viewport'), require('../utils/PropTypes/controlled'), require('../Helpers/anchorShape'), require('../Helpers/fixedToShape'), require('../Helpers/positionShape'), require('../Helpers/Layover'), require('../FontIcons/FontIcon'), require('../FontIcons/getDeprecatedIcon'), require('../TextFields/TextField'), require('./TableColumn'), require('./EditDialog'), require('./findTable'), require('./findFixedTo'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactDom, global.classnames, global.deprecated, global.keyCodes, global.getField, global.themeColors, global.viewport, global.controlled, global.anchorShape, global.fixedToShape, global.positionShape, global.Layover, global.FontIcon, global.getDeprecatedIcon, global.TextField, global.TableColumn, global.EditDialog, global.findTable, global.findFixedTo);
    global.EditDialogColumn = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactDom, _classnames, _deprecated, _keyCodes, _getField, _themeColors, _viewport, _controlled, _anchorShape, _fixedToShape, _positionShape, _Layover, _FontIcon, _getDeprecatedIcon, _TextField, _TableColumn, _EditDialog, _findTable, _findFixedTo) {
  'use strict';
  ...
  var EditDialogColumn = function (_PureComponent) {
    ...
    _createClass(EditDialogColumn, [{
      ...
      value: function render() {
        ...
        if (inline && !noIcon) {
          inlineEditIcon = _react2.default.cloneElement((0, _getDeprecatedIcon2.default)(inlineIconClassName, inlineIconChildren, inlineIcon), {
            key: 'edit-icon'
          });
        }
