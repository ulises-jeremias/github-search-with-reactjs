(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'classnames', 'react-prop-types/lib/deprecated', '../Helpers/fixedToShape', '../Helpers/positionShape', '../SelectFields/SelectField', './withTableFixes', './TableColumn'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../Helpers/fixedToShape'), require('../Helpers/positionShape'), require('../SelectFields/SelectField'), require('./withTableFixes'), require('./TableColumn'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.classnames, global.deprecated, global.fixedToShape, global.positionShape, global.SelectField, global.withTableFixes, global.TableColumn);
    global.SelectFieldColumn = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _classnames, _deprecated, _fixedToShape, _positionShape, _SelectField, _withTableFixes, _TableColumn) {
  'use strict';
