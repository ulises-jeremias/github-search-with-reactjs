(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'classnames', 'react-prop-types/lib/deprecated', '../utils/themeColors', '../utils/getCollapserStyles', '../utils/getField', '../Tooltips/injectTooltip', '../FontIcons/FontIcon', '../FontIcons/getDeprecatedIcon', '../Helpers/IconSeparator'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../utils/themeColors'), require('../utils/getCollapserStyles'), require('../utils/getField'), require('../Tooltips/injectTooltip'), require('../FontIcons/FontIcon'), require('../FontIcons/getDeprecatedIcon'), require('../Helpers/IconSeparator'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.classnames, global.deprecated, global.themeColors, global.getCollapserStyles, global.getField, global.injectTooltip, global.FontIcon, global.getDeprecatedIcon, global.IconSeparator);
    global.TableColumn = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _classnames, _deprecated, _themeColors, _getCollapserStyles, _getField, _injectTooltip, _FontIcon, _getDeprecatedIcon, _IconSeparator) {
  'use strict';
    ...
    _createClass(TableColumn, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['className', 'fixedStyle', 'fixedClassName', 'numeric', 'header', 'children', 'sorted', 'sortIcon', 'tooltip', 'selectColumnHeader', 'adjusted', 'grow', 'plain', 'scope', 'cellIndex', 'sortIconChildren', 'sortIconClassName']);
