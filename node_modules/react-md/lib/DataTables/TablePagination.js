(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'classnames', 'react-prop-types/lib/deprecated', '../utils/getField', '../Helpers/ResizeObserver', '../SelectFields/SelectField', '../Buttons/Button', '../FontIcons/FontIcon', '../FontIcons/getDeprecatedIcon', './findTable', './TableFooter', './TableColumn'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../utils/getField'), require('../Helpers/ResizeObserver'), require('../SelectFields/SelectField'), require('../Buttons/Button'), require('../FontIcons/FontIcon'), require('../FontIcons/getDeprecatedIcon'), require('./findTable'), require('./TableFooter'), require('./TableColumn'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.classnames, global.deprecated, global.getField, global.ResizeObserver, global.SelectField, global.Button, global.FontIcon, global.getDeprecatedIcon, global.findTable, global.TableFooter, global.TableColumn);
    global.TablePagination = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _classnames, _deprecated, _getField, _ResizeObserver, _SelectField, _Button, _FontIcon, _getDeprecatedIcon, _findTable, _TableFooter, _TableColumn) {
  'use strict';
