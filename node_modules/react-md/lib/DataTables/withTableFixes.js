(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-dom', 'prop-types', '../utils/getField', '../Helpers/fixedToShape', './findTable', './findFixedTo', '../utils/StringUtils/getDisplayName'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('react-dom'), require('prop-types'), require('../utils/getField'), require('../Helpers/fixedToShape'), require('./findTable'), require('./findFixedTo'), require('../utils/StringUtils/getDisplayName'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.reactDom, global.propTypes, global.getField, global.fixedToShape, global.findTable, global.findFixedTo, global.getDisplayName);
    global.withTableFixes = mod.exports;
  }
})(this, function (exports, _react, _reactDom, _propTypes, _getField, _fixedToShape, _findTable, _findFixedTo, _getDisplayName) {
  'use strict';
