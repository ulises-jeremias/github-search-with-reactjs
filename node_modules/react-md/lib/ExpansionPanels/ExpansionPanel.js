(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'classnames', 'react-prop-types/lib/deprecated', '../utils/getField', '../utils/themeColors', '../utils/getCollapserStyles', '../utils/PropTypes/controlled', '../Papers/Paper', '../Helpers/AccessibleFakeButton', '../Helpers/Collapse', '../FontIcons/FontIcon', '../FontIcons/getDeprecatedIcon', './PanelContent'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-dom'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../utils/getField'), require('../utils/themeColors'), require('../utils/getCollapserStyles'), require('../utils/PropTypes/controlled'), require('../Papers/Paper'), require('../Helpers/AccessibleFakeButton'), require('../Helpers/Collapse'), require('../FontIcons/FontIcon'), require('../FontIcons/getDeprecatedIcon'), require('./PanelContent'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactDom, global.classnames, global.deprecated, global.getField, global.themeColors, global.getCollapserStyles, global.controlled, global.Paper, global.AccessibleFakeButton, global.Collapse, global.FontIcon, global.getDeprecatedIcon, global.PanelContent);
    global.ExpansionPanel = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactDom, _classnames, _deprecated, _getField, _themeColors, _getCollapserStyles, _controlled, _Paper, _AccessibleFakeButton, _Collapse, _FontIcon, _getDeprecatedIcon, _PanelContent) {
  'use strict';
