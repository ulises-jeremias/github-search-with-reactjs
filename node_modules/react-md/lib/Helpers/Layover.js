(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'react-dom', 'prop-types', 'react-transition-group/CSSTransitionGroup', 'classnames', '../utils/EventUtils/handleWindowClickListeners', '../utils/Positioning/getSelectedTextPosition', '../utils/Positioning/getScroll', '../utils/Positioning/viewport', '../utils/Positioning/isOutOfBounds', './anchorShape', './fixedToShape', './positionShape', './HorizontalAnchors', './VerticalAnchors', './Positions', './ResizeObserver'], factory);
