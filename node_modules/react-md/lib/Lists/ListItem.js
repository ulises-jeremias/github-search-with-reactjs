(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'classnames', 'react-prop-types/lib/deprecated', '../utils/themeColors', '../utils/getCollapserStyles', '../utils/getField', '../utils/PropTypes/controlled', '../constants/keyCodes', '../Helpers/anchorShape', '../Helpers/fixedToShape', '../Helpers/AccessibleFakeInkedButton', '../Helpers/Collapse', '../FontIcons/FontIcon', '../FontIcons/getDeprecatedIcon', './TileAddon', './ListItemText', './List', '../Menus/Menu'], factory);
