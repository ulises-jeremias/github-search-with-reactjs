(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'classnames', 'react-transition-group/CSSTransitionGroup', 'react-prop-types/lib/deprecated', 'react-prop-types/lib/isRequiredForA11y', '../utils/getField', '../utils/PropTypes/controlled', '../utils/PropTypes/invalidIf', '../Buttons/Button', '../Drawers/Drawer', '../Lists/List', '../Toolbars/Toolbar', '../FontIcons/FontIcon', '../FontIcons/getDeprecatedIcon', '../Drawers/isType', './JumpToContentLink', './CloseButton', './MiniListItem'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('classnames'), require('react-transition-group/CSSTransitionGroup'), require('react-prop-types/lib/deprecated'), require('react-prop-types/lib/isRequiredForA11y'), require('../utils/getField'), require('../utils/PropTypes/controlled'), require('../utils/PropTypes/invalidIf'), require('../Buttons/Button'), require('../Drawers/Drawer'), require('../Lists/List'), require('../Toolbars/Toolbar'), require('../FontIcons/FontIcon'), require('../FontIcons/getDeprecatedIcon'), require('../Drawers/isType'), require('./JumpToContentLink'), require('./CloseButton'), require('./MiniListItem'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.classnames, global.CSSTransitionGroup, global.deprecated, global.isRequiredForA11y, global.getField, global.controlled, global.invalidIf, global.Button, global.Drawer, global.List, global.Toolbar, global.FontIcon, global.getDeprecatedIcon, global.isType, global.JumpToContentLink, global.CloseButton, global.MiniListItem);
    global.NavigationDrawer = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _classnames, _CSSTransitionGroup, _deprecated, _isRequiredForA11y, _getField, _controlled, _invalidIf, _Button, _Drawer, _List, _Toolbar, _FontIcon, _getDeprecatedIcon, _isType, _JumpToContentLink, _CloseButton, _MiniListItem) {
  'use strict';
