(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'classnames', 'react-prop-types/lib/deprecated', 'react-prop-types/lib/isRequiredForA11y', '../utils/getField', '../utils/Positioning/getTextWidth', '../utils/PropTypes/controlled', '../utils/PropTypes/invalidIf', '../utils/PropTypes/minNumber', '../utils/StringUtils/addSuffix', '../FontIcons/FontIcon', '../FontIcons/getDeprecatedIcon', './FloatingLabel', './TextFieldMessage', './PasswordButton', './InputField', './TextFieldDivider'], factory);
