(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', './TooltipContainer'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('./TooltipContainer'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.TooltipContainer);
    global.Tooltipped = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _TooltipContainer) {
  'use strict';
  ...
  function Tooltipped(_ref) {
    ...
    if (props.label) {
      target = _react2.default.cloneElement(target, setPosition ? _extends({}, targetProps, {
        style: _extends({}, targetProps.style, { position: 'relative' })
      }) : targetProps, [targetProps.children, _react2.default.createElement(_TooltipContainer2.default, _extends({
